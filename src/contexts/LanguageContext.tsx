...
const translations: Record<Language, Record<string, string>> = {
  pl: {
    ...
    'contact.form.privacyNotice': 'Wysyłając formularz, wyrażasz zgodę na kontakt w sprawie wizyty i przetwarzanie podanych danych zgodnie z polityką prywatności. W pierwszej wiadomości podaj tylko dane potrzebne do kontaktu.',
    'contact.form.privacyConsent': 'Potwierdzam, że zapoznałem/am się z polityką prywatności i akceptuję warunki przesłania formularza.',
    'contact.form.privacyError': 'Aby wysłać formularz, zaakceptuj warunki i politykę prywatności.',
    ...
    'cookies.analyticsNotice': 'Google Analytics zostanie uruchomione tylko wtedy, gdy wyrazisz zgodę na analityczne pliki cookies.',
    ...
    'cookies.acceptAnalytics': 'Wyrażam zgodę',
  ...
  en: {
    ...
    'contact.form.privacyNotice': 'By sending the form, you agree to being contacted regarding the appointment and to the processing of the provided data in accordance with the privacy policy. In the first message, share only the data needed for contact.',
    'contact.form.privacyConsent': 'I confirm that I have read the privacy policy and accept the terms for submitting the form.',
    'contact.form.privacyError': 'Please accept the terms and privacy policy before sending the form.',
    ...
    'cookies.analyticsNotice': 'Google Analytics will be enabled only if you consent to analytics cookies.',
    'cookies.readMore': 'to learn how data submitted through the form is processed.',
    'cookies.acceptAll': 'Accept all',
    'cookies.reject': 'Necessary only',
    'cookies.acceptAnalytics': 'I consent',
