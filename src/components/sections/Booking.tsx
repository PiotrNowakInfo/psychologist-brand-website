...
const Booking = () => {
    ...
    const calendlyUrls = {
        ...
        en: "https://calendly.com/surgerycode/katarzyna_gostkowska?month=2026-02" // TODO: Zmień na angielski odpowiednik zdarzenia, np. /consultation-en
    };
